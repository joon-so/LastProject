...
namespace DuloGames.UI
{
    public class ColorScheme : ScriptableObject
    {
        ...
        [SerializeField] private Color m_ImageBorders = Color.white;
        ...
        /// <summary>
        /// Gets or sets the Borders image color shade.
        /// </summary>
        public Color imageBorders
        {
            get { return this.m_ImageBorders; }
            set { this.m_ImageBorders = value; }
        }
