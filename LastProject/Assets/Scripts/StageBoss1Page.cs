...
public class StageBoss1Page : MonoBehaviour
{
    ...
    IEnumerator Move()
    {
        ...
        {
            move += Time.deltaTime;
            gameObject.transform.position = new Vector3(move, gameObject.transform.position.y, gameObject.transform.position.z);
            yield return null;
        }
    }
}
